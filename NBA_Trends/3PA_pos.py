...
plt.savefig(fname=r'C:\Users\wilso\Desktop\NBA_Analysis\NBA_Trends\figs\3PA_pos-boxen')
...
ax.set(ylabel="Avg 3PA Per Game", xlabel="Position")
plt.savefig(fname=r'C:\Users\wilso\Desktop\NBA_Analysis\NBA_Trends\figs\3PA_pos-line')