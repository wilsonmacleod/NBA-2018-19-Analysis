...
x = sns.jointplot(x=df['Unnamed: 6'], y=df['3PA'], kind='reg', xlim=(-30,30), ylim=(0,15), height = 4, 
...
x = sns.jointplot(x=df['Unnamed: 6'], y=df['AST'], kind='reg', xlim=(-25,30), ylim=(4,22), height = 4, 
